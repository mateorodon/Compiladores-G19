...
case 20:
#line 85 "gramatica.y"
{ if(noHayErrores()) {yyval.obj = new NodoComun("For",(Nodo)yyvsp[-2].obj,(Nodo)yyvsp[0].obj);}}
break;
case 21:
#line 86 "gramatica.y"
...
{ if(noHayErrores()){
                                                                                           ...
                                                                                           if (ambitoVar.equals("")) {
                                                                                            ...
                                                                                            NodoHoja constante = new NodoHoja(yyvsp[-9].sval, TablaSimbolos.getToken(yyvsp[-9].sval));
                                                                                           Nodo asignacion = new NodoComun(yyvsp[-10].sval, idAsignacion, constante); /*Cambie sval x obj*/
                                                                                           NodoHoja constante2 = new NodoHoja(yyvsp[-4].sval, TablaSimbolos.getToken(yyvsp[-4].sval));

                                                                                           Nodo incremento = new NodoComun("Incremento", (Nodo)yyvsp[-5].obj, constante2); /*Idem*/
...
{  if(noHayErrores()) {yyval.obj = new NodoComun("Sentencia", (Nodo) yyvsp[-2].obj, (Nodo) yyvsp[-1].obj);}
                                                    hasReturn = true;}
break;
case 60:
...
{if(noHayErrores()) {yyval.obj = new NodoComun("Sentencia", (Nodo) yyvsp[-1].obj, (Nodo) yyvsp[0].obj);}}
break;
case 64:
...
{if (ambito.length() < 5){  /*si es menor es que es main*/
                           ...
                           if(noHayErrores()) {yyval.obj = new NodoComun("Return", (Nodo)yyvsp[-1].obj);}
...
{inIF=true; if (noHayErrores()){yyval=yyvsp[0];}}
break;
case 99:
#line 664 "gramatica.y"
{AnalizadorLexico.agregarEstructura("Se reconocio un IF");inIF=false; if (noHayErrores()){ Nodo cuerpo = new NodoComun("Cuerpo",(Nodo)yyvsp[-1].obj);
...
{if (noHayErrores()){yyval = yyvsp[-1];} cantReturns++;}
break;
case 110:
...
{if (noHayErrores()){yyval = yyvsp[-2];} cantReturns++;}
break;
case 112:
...
{if (noHayErrores()){ yyval = new NodoComun("Sentencia", (Nodo) yyvsp[-2].obj, (Nodo) yyvsp[-1].obj);}}
break;
case 116:
...
#line 804 "gramatica.y"
{
    ...
    if (noHayErrores()){ yyval.obj = new NodoComun("Sentencia", (Nodo) yyvsp[-2].obj, (Nodo) yyvsp[0].obj);}
    }
break;
case 131:
